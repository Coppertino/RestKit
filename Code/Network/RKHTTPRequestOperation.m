...
@interface rkAFURLConnectionOperation () <NSURLConnectionDataDelegate>
...
{
    if ([rkAFHTTPRequestOperation instancesRespondToSelector:@selector(connection:willSendRequest:redirectResponse:)]) {
